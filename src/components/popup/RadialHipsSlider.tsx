...
interface RadialHipsSliderProps {
  value: number; // hips in cm
...
const MIN_CM = 73;  // ~29 inches
const MAX_CM = 137; // ~54 inches
...
export const RadialHipsSlider: React.FC<RadialHipsSliderProps> = ({ value, onChange, useMetric }) => {
